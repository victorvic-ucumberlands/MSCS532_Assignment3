...
print("Measuring time and memory usage of quick sort on random arrays")
for arr in [arr1, arr2, arr3, arr4, arr5, arr6]:
    #Write arr to a csv file
    with open('arr_random.csv', 'w', newline='') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerow(arr)
    #Call quick_sort_random.py on the csv file
    import subprocess
    subprocess.run(['python', 'quick_sort_random.py', '--input_file', 'arr_random.csv', '--output_file', 'sorted_arr_random.csv'])  
...
print("Measuring time and memory usage of quick sort on sorted arrays (ascending)")
for arr in [sorted_arr1, sorted_arr2, sorted_arr3, sorted_arr4, sorted_arr5, sorted_arr6]:
    ...
    with open('arr_sorted.csv', 'w', newline='') as csvfile:
        ...
        writer.writerow(arr)
    #Call quick_sort_random.py on the csv file
    subprocess.run(['python', 'quick_sort_random.py', '--input_file', 'arr_sorted.csv', '--output_file', 'sorted_arr_sorted.csv'])  
    #Read the stats from the text file
...
print("Measuring time and memory usage of quick sort on sorted arrays (descending)")
for arr in [sorted_arr1_desc, sorted_arr2_desc, sorted_arr3_desc, sorted_arr4_desc, sorted_arr5_desc, sorted_arr6_desc]:
    ...
    with open('arr_sorted_desc.csv', 'w', newline='') as csvfile:
        ...
        writer.writerow(arr)
    #Call quick_sort_random.py on the csv file
    subprocess.run(['python', 'quick_sort_random.py', '--input_file', 'arr_sorted_desc.csv', '--output_file', 'sorted_arr_sorted_desc.csv'])  
    #Read the stats from the text file
...
# Measure time and memory usage of quick sort on each sorted array (with repeated elements)
print("Measuring time and memory usage of quick sort on arrays with repeated elements")
for arr in [arr1_rep, arr2_rep, arr3_rep, arr4_rep, arr5_rep, arr6_rep]:
    ...
    with open('arr_sorted_rep.csv', 'w', newline='') as csvfile:
        ...
        writer.writerow(arr)
    #Call quick_sort_random.py on the csv file
    subprocess.run(['python', 'quick_sort_random.py', '--input_file', 'arr_sorted_rep.csv', '--output_file', 'sorted_arr_sorted_rep.csv'])  
    #Read the stats from the text file
